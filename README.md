...
- **No consent.json integration**: The persona dataset includes `consent.json` files that aren't consumed by the permission layer yet.

### Next Steps
- Wire `consent.json` into the permission layer for granular per-source consent
...
- Add Google Takeout / ChatGPT export importers for real personal data
