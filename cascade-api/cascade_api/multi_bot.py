...
async def create_bot_app(
    ...
    # Handle documents sent with /import caption (Telegram sends these as document messages, not commands)
    app.add_handler(MessageHandler(filters.Document.ALL, import_handler))
